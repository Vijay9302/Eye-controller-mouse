...
predictor = dlib.shape_predictor("shapepredictor_68_facelandmarks.dat") #Landmark identifier. Set the filename to whatever you named the downloaded file
nosetip=30
lelc=36
leup=38
ledn=41
